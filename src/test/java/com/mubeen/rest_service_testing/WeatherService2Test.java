...
//This tutorial is to learn to access json object data
public class WeatherService2Test extends TestCase {
...
//		Accessing inner objects
		...
		System.out.println("humidity = " + mainObj.get("humidity"));
...
//         }
	...
	private String sendGetWeather() throws Exception {
