...
//This tutorial is to create input data set and validate weather service against the data
public class WeatherService6Test extends TestCase {
	...
	public void testWeatherService1() throws Exception {
		...
		input.put("london", "uk");
		input.put("chicago", "usa");
		input.put("delhi", "india");
		input.put("Portland", "usa");
